 ...
 **hello-rails-back-end** is project to practice setting up a Rails/React project as two apps. This repository is the backend app.
 
 - [Link to Front-end](https://github.com/Mikey1-nuel/hello-react-front-end)
...
```sh
  cd my-folder
  https://github.com/Mikey1-nuel/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Mikey1-nuel/hello-rails-back-end/issues).
